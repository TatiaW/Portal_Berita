        ...
        <div class="row">
            <div class="col-lg-12 ">
                <div class="trending-tittle">
                    <a href="?page=upload_berita" class="genric-btn danger-border mx-2">Tambah Berita</a>
                    <a href="#" id="btnTambahKategori" class="genric-btn danger-border mx-2">Tambah Kategori</a>
